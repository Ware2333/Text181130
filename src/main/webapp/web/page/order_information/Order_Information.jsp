	...
	<body>
		...
		<script type="text/javascript">
			$("input[name='insert']").click(function() {
				update("/web/page/order_information/AddOrder_Information.jsp", function() {
			...
			formSubmit("/order_information/page.do", "submit(select)", "json", function(data) {
				...
				$.each(data.page, function(i, dom) {
					...
					html += "<td id='" + i + "'>" + dom.order_code + "</td>";
					html += "<td id='" + dom.usercode + "'>" + dom.username + "</td>";
					html += "<td id='" + i + "'>" + dom.order_time + "</td>";
					html += "<td id='" + i + "'>" + dom.receiving + "</td>";
					if (dom.descr == 1) {
						l = "已付款";
					} else {
						l = "未付款";
					...
					html += "<td id='" + i + "'>" + l + "</td>";
					var a = "<a href='javascript:update1(\"" + dom.order_code + "\")'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;";
					a += "<a href='javascript:delete1(\"" + dom.order_code + "\")'>删除</a>&nbsp;&nbsp;&nbsp;&nbsp;";
					a += "<a href='javascript:order(\"" + dom.order_code + "\")'>商品</a>";
			...
			function delete1(code) {
				layer.confirm("是否删除", {
					...
					ajax("/order_information/delete.do", {
						"order_code": code
					}, "text", function(data) {
						if (data == "success") {
							layer.alert("删除成功");
			...
			function order(code) {
				update("/web/page/order_information/Order_List.jsp?order_code=" + code, function() {
					window.location.reload();
				});
			}
