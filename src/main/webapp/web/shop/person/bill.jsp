											...
											<li>
												<div  class="cards-carousel">
													<div class="mask">
														...
														<div class="bank ng-binding" style="background-image: url(<%=path%>/images/combo.png);">ä¸­å½åä¸é¶è¡</div>
														<div class="details">
															<a>æ¥çè¯¦æ</a>
														</div>
													</div>
											...
											<li>
												<div  class="cards-carousel">
													<div class="mask">
														...
														<div class="bac fn-left"></div>
														<div class="bank ng-binding" style="background-image: url(<%=path%>/images/combo1.png);">ä¸­å½å»ºè®¾é¶è¡</div>
														<div class="details">
															<a>æ¥çè¯¦æ</a>
														</div>
													</div>
											...
											<li>
												<div  class="cards-carousel">
													<div class="mask">
														...
														<div class="bac fn-left"></div>
														<div class="bank ng-binding" style="background-image: url(<%=path%>/images/combo2.png);">æµ¦åé¶è¡</div>
														<div class="details">
															<a>æ¥çè¯¦æ</a>
														</div>
													</div>
											...
											<li>
												<div  class="cards-carousel">
													<div class="mask">
														...
														<div class="bac fn-left"></div>
														<div class="bank ng-binding" style="background-image: url(<%=path%>/images/combo3.png);">ä¸­å½åå¤§é¶è¡</div>
														<div class="details">
															<a>æ¥çè¯¦æ</a>
														</div>
													</div>
