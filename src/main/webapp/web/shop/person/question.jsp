			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">è®¾ç½®å®å¨é®é¢</strong> / <small>Set&nbsp;Safety&nbsp;Question</small></div>
					</div>
					<hr/>
					<!--è¿åº¦æ¡-->
					<div class="m-progress">
						<div class="m-progress-list">
							<span class="step-1 step">
                                ...
                                <p class="stage-name">è®¾ç½®å®å¨é®é¢</p>
                            </span>
					...
					<form class="am-form am-form-horizontal">
						<div class="am-form-group select">
							<label for="user-question1" class="am-form-label">é®é¢ä¸</label>
							<div class="am-form-content">
								<select data-am-selected>
									<option value="a" selected>è¯·éæ©å®å¨é®é¢</option>
									<option value="b">æ¨æåæ¬¢çé¢è²æ¯ä»ä¹ï¼</option>
									<option value="c">æ¨çæä¹¡å¨åªéï¼</option>
								</select>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-answer1" class="am-form-label">ç­æ¡</label>
							<div class="am-form-content">
								<input type="text" id="user-answer1" placeholder="è¯·è¾å¥å®å¨é®é¢ç­æ¡">
							</div>
						</div>
						<div class="am-form-group select">
							<label for="user-question2" class="am-form-label">é®é¢äº</label>
							<div class="am-form-content">
								<select data-am-selected>
									<option value="a" selected>è¯·éæ©å®å¨é®é¢</option>
									<option value="b">æ¨æåæ¬¢çé¢è²æ¯ä»ä¹ï¼</option>
						...
						<div class="am-form-group">
							<label for="user-answer2" class="am-form-label">ç­æ¡</label>
							<div class="am-form-content">
								<input type="text" id="user-answer2" placeholder="è¯·è¾å¥å®å¨é®é¢ç­æ¡">
							</div>
						</div>
						<div class="info-btn">
