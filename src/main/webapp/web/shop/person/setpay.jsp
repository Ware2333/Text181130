			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">æ¯ä»å¯ç </strong> / <small>Set&nbsp;Pay&nbsp;Password</small></div>
					</div>
					<hr/>
					<!--è¿åº¦æ¡-->
					<div class="m-progress">
						<div class="m-progress-list">
							<span class="step-1 step">
                                ...
                                <p class="stage-name">è®¾ç½®æ¯ä»å¯ç </p>
                            </span>
					...
					<form class="am-form am-form-horizontal">
						<div class="am-form-group bind">
							<label for="user-phone" class="am-form-label">éªè¯ææº</label>
							<div class="am-form-content">
								<span id="user-phone">186XXXX0531</span>
							</div>
						</div>
						<div class="am-form-group code">
							<label for="user-code" class="am-form-label">éªè¯ç </label>
							<div class="am-form-content">
								<input type="tel" id="user-code" placeholder="ç­ä¿¡éªè¯ç ">
							</div>
						...
						<div class="am-form-group">
							<label for="user-password" class="am-form-label">æ¯ä»å¯ç </label>
							<div class="am-form-content">
								<input type="tel" id="user-password" placeholder="6ä½æ°å­">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">ç¡®è®¤å¯ç </label>
							<div class="am-form-content">
								<input type="tel" id="user-confirm-password" placeholder="è¯·åæ¬¡è¾å¥ä¸é¢çå¯ç ">
							</div>
						</div>
						<div class="info-btn">
