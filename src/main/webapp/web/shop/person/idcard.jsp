			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">å®åè®¤è¯</strong> / <small>Real&nbsp;authentication</small></div>
					</div>
					<hr/>
					<div class="authentication">
						<p class="tip">è¯·å¡«åæ¨èº«ä»½è¯ä¸ççå®ä¿¡æ¯ï¼ä»¥ç¨äºæ¥å³å®¡æ ¸</p>
						<div class="authenticationInfo">
							<p class="title">å¡«åä¸ªäººä¿¡æ¯</p>
						...
						<div class="authenticationPic">
							<p class="title">ä¸ä¼ èº«ä»½è¯ç§ç</p>
							<p class="tip">è¯·æè¦æ±ä¸ä¼ èº«ä»½è¯</p>
							<ul class="cardlist">
								<li>
									<div class="cardPic">
										<img src="<%=path%>/images/cardbg.jpg">
										<div class="cardText"><i class="am-icon-plus"></i>
											<p>æ­£é¢ç§ç</p>
										</div>
										<p class="titleText">èº«ä»½è¯æ­£é¢</p>
									</div>
									<div class="cardExample">
										<img src="<%=path%>/images/cardbg.jpg">
										<p class="titleText">ç¤ºä¾</p>										
									</div>
								...
								<li>
									<div class="cardPic">
										...
										<p class="titleText">èº«ä»½è¯èé¢</p>
									</div>
									<div class="cardExample">
										<img src="<%=path%>/images/cardbg.jpg">
										<p class="titleText">ç¤ºä¾</p>										
						...
						<div class="info-btn">
							<div class="am-btn am-btn-danger">æäº¤</div>
						</div>
					</div>
				</div>
				<!--åºé¨-->
