			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">æè§åé¦</strong> / <small>Suggest</small></div>
					</div>
					<hr/>
					<div class="suggestmain">
						<p>è¯·çä¸æ¨çå®è´µæè§ï¼</p>
						<div class="suggestlist">
							<select data-am-selected>
								<option value="a" selected>è¯·éæ©æè§ç±»å</option>
								<option value="b">äº§åé®é¢</option>
								<option value="c">ä¿éé®é¢</option>
								<option value="d">æ¯ä»é®é¢</option>
								<option value="e">éæ¬¾é®é¢</option>
								<option value="f">ééé®é¢</option>
								<option value="g">å®åé®é¢</option>
								<option value="h">åç¥¨é®é¢</option>
								<option value="o">éæ¢è´§</option>
								<option value="m">å¶ä»</option>
							</select>
						</div>
						<div class="suggestDetail">
							<p>æè¿°é®é¢ï¼</p>
							<blockquote class="textArea">
								<textarea name="opinionContent" id="say_some" cols="60" rows="5" autocomplete="off" placeholder="å¨æ­¤æè¿°æ¨çæè§å·ä½åå®¹"></textarea>
								<div class="fontTip"><i class="cur">0</i> / <i>200</i></div>
							</blockquote>
						</div>
						<div class="am-btn am-btn-danger anniu">æäº¤</div>
						<p class="suggestTel"><i class="am-icon-phone"></i>å®¢æçµè¯ï¼400-007-1234</p>
					</div>
				</div>
				<!--åºé¨-->
				<div class="footer">
