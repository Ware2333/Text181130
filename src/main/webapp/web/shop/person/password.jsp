			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">ä¿®æ¹å¯ç </strong> / <small>Password</small></div>
					</div>
					<hr/>
					<!--è¿åº¦æ¡-->
					...
					<form class="am-form am-form-horizontal">
						<div class="am-form-group">
							<label for="user-old-password" class="am-form-label">åå¯ç </label>
							<div class="am-form-content">
								<input type="password" id="user-old-password" placeholder="è¯·è¾å¥åç»å½å¯ç ">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">æ°å¯ç </label>
							<div class="am-form-content">
								<input type="password" id="user-new-password" placeholder="ç±æ°å­ãå­æ¯ç»å">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">ç¡®è®¤å¯ç </label>
							<div class="am-form-content">
								<input type="password" id="user-confirm-password" placeholder="è¯·åæ¬¡è¾å¥ä¸é¢çå¯ç ">
							</div>
						</div>
						<div class="info-btn">
