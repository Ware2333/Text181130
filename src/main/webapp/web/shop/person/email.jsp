			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">ç»å®é®ç®±</strong> / <small>Email</small></div>
					</div>
					<hr/>
					<!--è¿åº¦æ¡-->
					...
					<form class="am-form am-form-horizontal">
						<div class="am-form-group">
							<label for="user-email" class="am-form-label">éªè¯é®ç®±</label>
							<div class="am-form-content">
								<input type="email" id="user-email" placeholder="è¯·è¾å¥é®ç®±å°å">
							</div>
						</div>
						<div class="am-form-group code">
							<label for="user-code" class="am-form-label">éªè¯ç </label>
							<div class="am-form-content">
								<input type="tel" id="user-code" placeholder="éªè¯ç ">
							</div>
