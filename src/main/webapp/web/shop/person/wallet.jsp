			...
			<div class="col-main">
				<div class="main-wrap">
						...
						<div class="am-cf am-padding">
							<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">è´¦æ·ä½é¢</strong> / <small>Account&nbsp;Balance</small></div>
						</div>
						<hr/>	
						<div class="finance">
							...
							<div class="financeTip">
								<img src="<%=path%>/images/Balance.png" />
								<a href="walletlist.html">æ¥çè´¦æ·æç»</a>
								<p>æç¤ºï¼ä½é¢æ¯æ¨å¨æ¬ååçä¸ä¸ªè´¦æ·ï¼å¦è´¦æ·åææ¬¾é¡¹ï¼ä¸åæ¶å¯ä»¥ç´æ¥å¾éä½¿ç¨ï¼æµæ¶é¨åæ»é¢ï¼æ¹ä¾¿å¿«æ·å®å¨é«æã</p>
							</div>
						</div>
				</div>
				<!--åºé¨-->
