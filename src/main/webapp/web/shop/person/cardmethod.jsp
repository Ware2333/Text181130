			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">é¶è¡å¡ç»å®</strong> / <small>Bind&nbsp;Card</small></div>
					</div>
					<hr/>
					<!--è¿åº¦æ¡-->
					<div class="m-progress">
						<div class="m-progress-list">
							<span class="step-1 step">
                                ...
                                <p class="stage-name">å®åè®¤è¯</p>
                            </span>
							<span class="step-2 step">
                                <em class="u-progress-stage-bg"></em>
                                <i class="u-stage-icon-inner">2<em class="bg"></em></i>
                                <p class="stage-name">å®æ</p>
                            </span>
					...
					<form class="am-form am-form-horizontal">
						<div class="am-form-group">
							<label for="user-name" class="am-form-label">çå®å§å</label>
							<div class="am-form-content">
								<input type="text" id="user-name" placeholder="è¯·è¾å¥æ¨ççå®å§å">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-IDcard" class="am-form-label">èº«ä»½è¯å·</label>
							<div class="am-form-content">
								<input type="tel" id="user-IDcard" placeholder="è¯·è¾å¥æ¨çèº«ä»½è¯ä¿¡æ¯">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-BankID" class="am-form-label">é¶è¡å¡å·</label>
							<div class="am-form-content">
								<input type="tel" id="user-BankID" placeholder="è¯·è¾å¥è¦ç»å®çé¶è¡å¡å¡å·">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-phone" class="am-form-label">ææºå·ç </label>
							<div class="am-form-content">
								<input type="tel" id="user-phone" placeholder="è¯·è¾å¥æ­¤å¡çé¢çææºå·">
							</div>
						</div>	
						<div class="am-form-group code">
							<label for="user-new-code" class="am-form-label">éªè¯ç </label>
							<div class="am-form-content">
								<input type="tel" id="user-new-code" placeholder="ç­ä¿¡éªè¯ç ">
							</div>
							<a class="btn" href="javascript:void(0);" onclick="sendMobileCode();" id="sendMobileCode">
								<div class="am-btn am-btn-danger">éªè¯ç </div>
							</a>
						</div>						
						<div class="info-btn">
							<div class="am-btn am-btn-danger">å¼éåè®®å¹¶ç¡®å®</div>
						</div>
