				...
				<div class="main-wrap">
					<div class="points">
						...
						<div class="pointsTitle">
						   ...
						   <div class="signIn"><a href="#"><i class="am-icon-calendar"></i><em>+5</em>æ¯æ¥ç­¾å°</a></div>
						</div>
						<div class="pointlist am-tabs" data-am-tabs>
							<ul class="am-avg-sm-3 am-tabs-nav am-nav am-nav-tabs">
								<li class="am-active"><a href="#tab1">å¨é¨</a></li>
								<li><a href="#tab2">è·å¾</a></li>
								<li><a href="#tab3">æ¯åº</a></li>
							</ul>
							<div class="am-tabs-bd">
								<div class="am-tab-panel am-fade am-in am-active" id="tab1">
									<table>
										...
										<thead>
											<tr>												
												<th class="th1">ç§¯åè¯¦æ</th>
												<th class="th2">ç§¯ååå¨</th>
												<th class="th3">æ¥æ</th>
											</tr>
										</thead>										
										<tbody>
											<tr>
												<td class="pointType">ç§¯ååæ¢</td>
