					...
					<div class="marqueen">
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								...
								<em>
									Hi,<span class="s-name"><%=session.getAttribute("user")==null?"请登陆":session.getAttribute("user")%></span>
									<a href="#"><p>点击更多优惠活动</p></a>									
								</em>
							</div>
							<%=session.getAttribute("user")==null?"<div class='member-logout'><a class='am-btn-warning btn' href='/Text181130/web/login.jsp'>登录</a><a class='am-btn-warning btn' href='/Text181130/web/register.jsp'>注册</a></div>":""%>
			...
			$.ajax({
				...
				success:function(data){
					...
					$.each(data.commodity_class,function(i,dom){
						html += '<li class="appliance js_toggle relative"><div class="category-info"><h3 class="category-name b-category-name"><i><img src="<%=path%>/images/cake.png"></i><a class="ml-22" title="点心">'+dom.name+'</a></h3><em>&gt;</em></div><div class="menu-item menu-in top" style="display: none;"><div class="area-in"><div class="area-bg"><div class="menu-srot"><div class="sort-side" id="'+dom.code+'"></div></div></div></div></div></li>';
					$.ajax({
						url:"/Text181130/commodityController/selectall.do",
						type:"post",
						dataType:"json",
						...
						success:function(con){
				            var html1 = "";
							$.each(con.commodity_class,function(i,dome){
								html1 += '<dd><a title="'+dome.name+'" href="/Text181130/web/shop/search.jsp?code='+dome.code+'"><span>'+dome.name+'</span></a></dd>';
							});
							$("#"+dom.code+"").html(html1);
						}
					});
